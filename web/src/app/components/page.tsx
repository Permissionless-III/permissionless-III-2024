          ...
          <ol className="mt-8 space-y-6">
            <li className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 text-xs font-medium">
                <div className="bg-primary-50 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  50
                </div>
                <div className="bg-primary-100 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  100
                </div>
                <div className="bg-primary-200 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  200
                </div>
                <div className="bg-primary-300 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  300
                </div>
                <div className="bg-primary-400 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  400
                </div>
                <div className="bg-primary-500 flex h-10 w-10 items-center justify-center rounded-xl text-black">
                  500
                </div>
                <div className="bg-primary-600 flex h-10 w-10 items-center justify-center rounded-xl text-white">
                  600
                </div>
                <div className="bg-primary-700 flex h-10 w-10 items-center justify-center rounded-xl text-white">
                  700
                </div>
                <div className="bg-primary-800 flex h-10 w-10 items-center justify-center rounded-xl text-white">
                  800
                </div>
                <div className="bg-primary-900 flex h-10 w-10 items-center justify-center rounded-xl text-white">
                  900
                </div>
                <div className="bg-primary-950 flex h-10 w-10 items-center justify-center rounded-xl text-white">
                  950
                </div>
              </div>
            </li>
